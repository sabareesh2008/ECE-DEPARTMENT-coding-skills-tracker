...
function openSection(section) {
  ...
  if (section === "OVERALL") {
    ...
    currentViewTitle.textContent = `${YEAR_LABELS[selectedYear]} · Overall ECE Leaderboard`;
    printTitle.textContent = `${YEAR_LABELS[selectedYear]} · Overall ECE LeetCode Leaderboard`;
    rankLegendText.textContent = "Overall Rank";
  } else {
    currentViewLabel.textContent = "SECTION";
    currentViewTitle.textContent = `${YEAR_LABELS[selectedYear]} · ${section} Leaderboard`;
    printTitle.textContent = `${YEAR_LABELS[selectedYear]} · ${section} LeetCode Leaderboard`;
